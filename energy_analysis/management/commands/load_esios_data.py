...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--resolution', choices=['fifteen_minutes', 'hour', 'day', 'month', 'year'])
    ...
    def handle(self, *args, **options):
        ...
        total_created, total_updated = self._process_date_range(
            ...
            start_date, end_date, chunk_days, options['resolution']
        )
    ...
    def _get_or_create_indicator(self, indicator_id):
        ...
        try:
            return EnergyIndicator.objects.get(indicator_id=indicator_id)
        except EnergyIndicator.DoesNotExist:
            # Create with basic defaults for known indicators
            defaults = {
                1293: {'name': 'Demand', 'unit': 'MW'},
                1161: {'name': 'Solar PV', 'unit': 'MW'},
                1159: {'name': 'Onshore Wind', 'unit': 'MW'},
                600: {'name': 'Spot Price', 'unit': 'EUR/MWh'},
            }
            
            indicator_data = defaults.get(indicator_id, {
                'name': f'ESIOS Indicator {indicator_id}',
                'unit': 'MW'
            })
            indicator_data['indicator_id'] = indicator_id
        ...
        while current_start <= end_date:
            ...
            try:
                ...
                if chunk_created > 0 or chunk_updated > 0:
                    ...
                    self.stdout.write(f"  No new data")
    ...
    def _process_chunk(self, esios_indicator, indicator_obj, indicator_id, 
        ...
        return self._save_data_points(data, indicator_obj, indicator_id, resolution or 'hour')
